...
part of 'ison_ionicon_builder.dart';
...
class JsonIoniconBuilder extends _JsonIoniconBuilder {
  const JsonIoniconBuilder({required super.args});
  ...
  @override
  JsonIoniconBuilderModel createModel({
    ChildWidgetBuilder? childBuilder,
    required JsonWidgetData data,
  }) {
    final model = JsonIoniconBuilderModel.fromDynamic(
      args,
...
class Ionicon extends JsonWidgetData {
  Ionicon(
    this.icon, {
    ...
    this.weight,
          ...
          jsonWidgetArgs: JsonIoniconBuilderModel.fromDynamic(
            {
              'color': color,
              'fill': fill,
              'grade': grade,
          ...
          jsonWidgetBuilder: () => JsonIoniconBuilder(
            args: JsonIoniconBuilderModel.fromDynamic(
              {
                'color': color,
                'fill': fill,
                'grade': grade,
          ...
          jsonWidgetType: JsonIoniconBuilder.kType,
        );
...
/// Creates an icon.
class JsonIoniconBuilderModel extends JsonWidgetBuilderModel {
  ...
  static JsonIoniconBuilderModel fromDynamic(
    dynamic map, {
    Map<String, dynamic> args = const {},
    JsonWidgetRegistry? registry,
  }) {
    ...
    if (result == null) {
      throw Exception(
        '[JsonIoniconBuilder]: requested to parse from dynamic, but the input is null.',
      );
    }
  ...
  static JsonIoniconBuilderModel? maybeFromDynamic(
    dynamic map, {
    Map<String, dynamic> args = const {},
    JsonWidgetRegistry? registry,
  }) {
    JsonIoniconBuilderModel? result;
    ...
    if (map != null) {
      ...
      if (map is JsonIoniconBuilderModel) {
        result = map;
      } else {
        registry ??= JsonWidgetRegistry.instance;
        map = registry.processArgs(map, <String>{}).value;
        result = JsonIoniconBuilderModel(
          args,
          color: () {
...
class IoniconSchema {
  static const id =
      'https://peiffer-innovations.github.io/flutter_json_schemas/schemas/json_dynamic_widget_plugin_ionicons/icon.json';
